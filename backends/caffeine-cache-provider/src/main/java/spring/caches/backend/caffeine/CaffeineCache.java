...
/*
 * NOTE: Copied from {@code https://github.com/spring-projects/spring-framework/blob/main/spring-context-support
 * /src/main/java/org/springframework/cache/caffeine/CaffeineCache.java}
 *
...
class CaffeineCache extends AbstractValueAdaptingCache {
     ...
     */
    CaffeineCache(String name, com.github.benmanes.caffeine.cache.Cache<Object, Object> cache) {
    ...
    public ValueWrapper putIfAbsent(Object key, @Nullable final Object value) {
        ...
        return (callable.called ? null : toValueWrapper(this.cache.get(key, callable)));
    }
    ...
    private class PutIfAbsentFunction implements Function<Object, Object> {
        ...
        PutIfAbsentFunction(@Nullable Object value) {
            this.value = value;
        }
